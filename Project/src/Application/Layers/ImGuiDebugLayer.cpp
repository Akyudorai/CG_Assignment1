...
void ImGuiDebugLayer::_RenderGameWindow()
{
	...
	if (ImGui::Button(buffer) || InputEngine::GetKeyState(GLFW_KEY_P) == ButtonState::Pressed) {
		...
		InputEngine::SetCursorMode((scene->IsPlaying) ? CursorMode::Disabled : CursorMode::Normal);
